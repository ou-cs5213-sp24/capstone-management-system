"""
Django settings for capstonecms project.
...
SECRET_KEY = 'django-insecure-@37(nr-9f@41giy*)w9j!2cx$1(*6e03l2cf_tr6piy$ly43mn'
...
ROOT_URLCONF = 'capstonecms.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            os.path.join(BASE_DIR, "capstonecms", "templates"),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'capstonecms.wsgi.application'
